/*
CONDITIONALS - Conditional statements control behavior in JavaScript and determine whether or not pieces of code can run. Conditionals will chick if an expression is true.
IF the expression is true, a block of code will run.
*/
